...
export default function ChatInput({ onSubmit, isLoading, placeholder, label }: ChatInputProps) {
  ...
  return (
    <div className="space-y-2">
      {label !== undefined ? (
        ...
        <label className="text-sm font-medium text-slate-700 dark:text-slate-300">Or paste text directly</label>
      )}
      <div className="relative">
        <textarea
          ...
          placeholder={placeholder || "Paste or type content to analyze... (Enter to send, Shift+Enter for newline)"}
          rows={4}
